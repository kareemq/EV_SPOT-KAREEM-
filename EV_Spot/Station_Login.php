...
$Error = 'Error ... Please Check Station Username Or Password !';
...
<head>
    ...
    <title>EV Spot - Stations Portal | Login</title>
...
<body class="white-bg" class="" style="background-color:#fff">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div>
                ...
                <img src="Stations/img/logo.png" class="img-rounded" width="80%"/>

            </div>
                    <h2 class="font-bold">Station Login</h2>
            
            </p>
            <form class="m-t" role="form" method="post" action="Station_Login.php">
  ...
  <p class="m-t"> <small><br>EV Spot © 2022. All Rights Reserved </small> </p>
        </div>
    </div>
