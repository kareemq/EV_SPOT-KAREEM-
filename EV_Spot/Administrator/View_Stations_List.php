...
<body style="back">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Stations List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from stations order by ID DESC");
 ...
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Station ?')==true)
{location.replace('Delete_Station.php?S_ID=<?php echo $S_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a><br>  <a href="Edit_Station.php?S_ID=<?php echo $S_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a></center></td>
 </tr>
