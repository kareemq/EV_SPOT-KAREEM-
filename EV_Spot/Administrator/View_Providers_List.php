...
<body style="back">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Providers List Information</h5>
 ...
 <a href="JavaScript:if(confirm('Are You Sure To Accept This Provider ?')==true)
{location.replace('Accept_Provider.php?P_ID=<?php echo $P_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Accept</a><br>
 
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Provider ?')==true)
{location.replace('Delete_Provider.php?P_ID=<?php echo $P_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a><br>  <a href="Edit_Provider.php?P_ID=<?php echo $P_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a></center></td>
 </tr>
