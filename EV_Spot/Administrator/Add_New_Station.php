...
$insert = mysqli_query($dbConn,"insert into stations (Name,Phone_Number,Address,Longitude,Latitude,Username,Password,Status) values ('$Name','$Phone_Number','$Address','$Longitude','$Latitude','$Username','$Password','$Status')");
                     ...
                     <form method="post" action="Add_New_Station.php" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Phone Number *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:450px" type="text" name="Phone_Number" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBCC3rHaqjNvzdrImcm7vllRtDgbAT-AaY&callback=initMap" async defer></script>
