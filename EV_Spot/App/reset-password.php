...
$sql = mysqli_query($dbConn,"select * from providers where Phone_Number='$Phone_Number'");
...
$sql1 = mysqli_query($dbConn,"update providers set Password='$New_Password' where ID='$P_ID'");
...
.signin form a, .signup form a, .change-password form a {
  color: #fff;
   ...
   <body >
    ...
    <div class="site">
        <!-- site__mobile-header -->
        <header class="site__mobile-header" style="position: fixed; z-index: 1;">
 ...
 <div><input type="email" name="Phone_Number" placeholder="Phone Number" required></div>
