...
$sql1 = mysqli_query($dbConn,"select * from requests where EP_ID='$S_ID' AND EP_Type='Station'");
                ...
                <div class="wrapper wrapper-content">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                            ...
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
													...
													<br>
														...
														<img src="img/logo.png" width="25%"/></center></strong>
								...
								<div class="col-lg-12" >
                <div class="widget style1 lazur-bg" style="background-color:#1e7283">
                    <div class="row">
                        <div class="col-xs-4">
